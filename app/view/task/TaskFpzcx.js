Ext.define('Zixweb.view.task.TaskFpzcx', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.taskfpzcx',
			...
			columns : [{
						...
						items : [{
							...
							handler : function(grid, rowIndex, colIndex) {
								...
								var center = grid.up('center'), id = 'yspzq_fdetail_'
										+ rec.data.ys_type + rec.data.ys_id, cmp = Ext
										.getCmp(id);
								if (cmp) {
									center.setActiveTab(cmp);
								} else {
									var taskfpzcxdetail = Ext
											.createByAlias('widget.taskfpzcxdetail');
									taskfpzcxdetail.store.load({
												params : {
													id : rec.data.id,
