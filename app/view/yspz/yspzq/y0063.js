Ext.define('Zixweb.view.yspz.yspzq.y0063', {
		...
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('yspzqy0063form').getForm();
							var values = form.getValues();
							var grid = Ext.getCmp('yspzq_y0063_grid');
							if (form.isValid()) {
						...
						items : [{
							...
							handler : function(grid, rowIndex, colIndex) {
								...
								var viewport = grid.up('viewport'), center = viewport
										.down('center'), id = 'yspzq_detail_0063'
								...
								if (cmp) {
									...
									center.add({
										...
										xtype : 'panel',
										items : yspzqdetail,
										id : 'yspzq_detail_0063' + rec.data.id,
										title : '凭证0063' + '编号' + rec.data.id
												+ '详细信息'
									}).show();
								}
								viewport.doLayout();
