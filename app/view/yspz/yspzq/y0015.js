Ext.define('Zixweb.view.yspz.yspzq.y0015', {
		...
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('yspzqy0015form').getForm();
							var values = form.getValues();
							var grid = Ext.getCmp('yspzq_y0015_grid');
							if (form.isValid()) {
