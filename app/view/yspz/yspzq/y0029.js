Ext.define('Zixweb.view.yspz.yspzq.y0029', {
		...
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('yspzqy0029form').getForm();
							var values = form.getValues();
							var grid = Ext.getCmp('yspzq_y0029_grid');
							if (form.isValid()) {
								...
								items : [{
									...
									handler : function(grid, rowIndex, colIndex) {
										...
										var viewport = grid.up('viewport'), center = viewport
												.down('center'), id = 'yspzq_detail_0029'
												+ rec.data.id, cmp = Ext
												.getCmp(id);
										var yspzqdetail = Ext
