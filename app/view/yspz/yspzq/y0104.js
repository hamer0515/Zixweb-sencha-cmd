Ext.define('Zixweb.view.yspz.yspzq.y0104', {
		...
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('yspzqy0104form').getForm();
							var values = form.getValues();
							var grid = Ext.getCmp('yspzq_y0104_grid');
							if (form.isValid()) {
						...
						items : [{
							...
							handler : function(grid, rowIndex, colIndex) {
								...
								var viewport = grid.up('viewport'), center = viewport
										.down('center'), id = 'yspzq_detail_0104'
								...
								if (cmp) {
									...
									center.add({
										...
										xtype : 'panel',
										items : yspzqdetail,
										id : 'yspzq_detail_0104' + rec.data.id,
										title : '凭证0104' + '编号' + rec.data.id
												+ '详细信息'
									}).show();
								}
								viewport.doLayout();
