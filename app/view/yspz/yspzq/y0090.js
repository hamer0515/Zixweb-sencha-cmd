Ext.define('Zixweb.view.yspz.yspzq.y0090', {
		...
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('yspzqy0090form').getForm();
							var values = form.getValues();
							var grid = Ext.getCmp('yspzq_y0090_grid');
							if (form.isValid()) {
						...
						items : [{
							...
							handler : function(grid, rowIndex, colIndex) {
								...
								var viewport = grid.up('viewport'), center = viewport
										.down('center'), id = 'yspzq_detail_0090'
								...
								if (cmp) {
									...
									center.add({
										...
										xtype : 'panel',
										items : yspzqdetail,
										id : 'yspzq_detail_0090' + rec.data.id,
										title : '凭证0090' + '编号' + rec.data.id
												+ '详细信息'
									}).show();
								}
								viewport.doLayout();
