		...
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('yspzqy0037form').getForm();
							var values = form.getValues();
							var grid = Ext.getCmp('yspzq_y0037_grid');
							if (form.isValid()) {
							...
							handler : function(grid, rowIndex, colIndex) {
								...
								if (cmp) {
									...
									center.add({
										...
										xtype : 'panel',
										items : yspzqdetail,
										id : 'yspzq_detail_0037' + rec.data.id,
										title : '凭证0037' + '编号' + rec.data.id
												+ '详细信息'
									}).show();
								}
								viewport.doLayout();
