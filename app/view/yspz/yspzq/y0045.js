Ext.define('Zixweb.view.yspz.yspzq.y0045', {
		...
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('yspzqy0045form').getForm();
							var values = form.getValues();
							var grid = Ext.getCmp('yspzq_y0045_grid');
							if (form.isValid()) {
