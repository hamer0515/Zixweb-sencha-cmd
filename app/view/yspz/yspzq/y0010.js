Ext.define('Zixweb.view.yspz.yspzq.y0010', {
		...
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('yspzqy0010form').getForm();
							var values = form.getValues();
							var grid = Ext.getCmp('yspzq_y0010_grid');
							if (form.isValid()) {
								...
								items : [{
									...
									handler : function(grid, rowIndex, colIndex) {
										...
										var viewport = grid.up('viewport'), center = viewport
												.down('center'), id = 'yspzq_detail_0010'
												+ rec.data.id, cmp = Ext
												.getCmp(id);
										var yspzqdetail = Ext
