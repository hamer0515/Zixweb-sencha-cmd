Ext.define('Zixweb.view.book.detail.cost_dcch_fhyd', {
		...
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('costdcchfhyddetailform')
									.getForm();
							var values = form.getValues();
							var grid = Ext
									.getCmp('book_detail_cost_dcch_fhyd_grid');
							grid.down('#fm').hide();
		...
		this.items = [{
					...
					items : [{
								...
								items : [{
											...
											allowBlank : false,
											verify : {
												id : 'book_detail_cost_dcch_fhyd_to'
											},
											vtype : 'dateinterval',
											width : 180
										}, {
					...
					xtype : 'gridpanel',
					id : 'book_detail_cost_dcch_fhyd_grid',
					height : 'auto',
					store : this.store,
					dockedItems : [{
								xtype : 'pagingtoolbar',
