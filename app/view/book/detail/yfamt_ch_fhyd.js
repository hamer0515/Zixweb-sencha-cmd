Ext.define('Zixweb.view.book.detail.yfamt_ch_fhyd', {
		...
		this.items = [{
					...
					items : [{
								...
								items : [{
											...
											allowBlank : false,
											verify : {
												id : 'book_detail_yfamt_ch_fhyd_to'
											},
											vtype : 'dateinterval',
											width : 180
										}, {
								...
								items : [{
											...
											margin : '0 10 0 0',
											verify : {
												id : 'book_detail_yfamt_ch_fhyd_to_2'
											},
											vtype : 'dateinterval',
											width : 180
										}, {
					...
					xtype : 'gridpanel',
					id : 'book_detail_yfamt_ch_fhyd_grid',
					height : 'auto',
					store : this.store,
					dockedItems : [{
								xtype : 'pagingtoolbar',
