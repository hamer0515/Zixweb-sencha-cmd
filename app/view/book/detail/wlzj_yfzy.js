Ext.define('Zixweb.view.book.detail.wlzj_yfzy', {
	...
	initComponent : function() {
		...
		var grid = new Ext.grid.Panel({
					...
					columns : [columns.wlzj_type, columns.period, columns.j,
							columns.d]
				});
		this.items = [{
			xtype : 'form',
			...
			items : [{
						...
						handler : function() {
							...
							Ext.Ajax.request({
								async : false,
								url : 'book/detail/wlzj_yfzy_excel',
								params : params,
