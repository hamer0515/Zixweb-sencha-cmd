	...
	initComponent : function() {
		...
		var store = new Ext.data.Store({
				...
				var grid = new Ext.grid.Panel({
							...
							columns : [columns.acct, columns.period, columns.j, columns.d]
						});
		this.items = [{
					xtype : 'form',
					title : '查询',
					...
					items : [{
								...
								handler : function() {
									...
									Ext.Ajax.request({
										async : false,
										url : 'book/detail/income_zhlx_excel',
										params : params,
