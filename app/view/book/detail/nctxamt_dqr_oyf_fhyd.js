Ext.define('Zixweb.view.book.detail.nctxamt_dqr_oyf_fhyd', {
	...
	initComponent : function() {
		var store = new Ext.data.Store({
					fields : ['fch_ssn', 'fs_rate', 'fhw_type', 'fc', 'ftx_date', 'period', 'j', 'd'],
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('nctxamtdqroyffhyddetailform')
									.getForm();
							var values = form.getValues();
							var grid = Ext
									.getCmp('book_detail_nctxamt_dqr_oyf_fhyd_grid');
		...
		this.items = [{
					xtype : 'form',
					title : '查询',
					id : 'nctxamtdqroyffhyddetailform',
					bodyPadding : 5,
					collapsible : true,
					...
					items : [{
								...
								items : [{
											...
											allowBlank : false,
											verify : {
												id : 'book_detail_nctxamt_dqr_oyf_fhyd_to'
											},
											vtype : 'dateinterval',
											width : 180
										}, {
								...
								items : [{
											...
											margin : '0 10 0 0',
											verify : {
												id : 'book_detail_nctxamt_dqr_oyf_fhyd_to_2'
											},
											vtype : 'dateinterval',
											width : 180
										}, {
					...
					xtype : 'gridpanel',
					id : 'book_detail_nctxamt_dqr_oyf_fhyd_grid',
					height : 'auto',
					store : this.store,
					dockedItems : [{
								xtype : 'pagingtoolbar',
