Ext.define('Zixweb.view.book.hist.fee_jrjg', {
		...
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							...
							var grid = Ext.getCmp('book_hist_fee_jrjg_grid');
							if (form.isValid()) {
