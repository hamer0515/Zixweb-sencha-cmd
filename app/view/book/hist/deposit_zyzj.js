Ext.define('Zixweb.view.book.hist.deposit_zyzj', {
	...
	initComponent : function() {
		var store = new Ext.data.Store({
			fields : ['id', 'zyzj_acct', 'period', 'j', 'd', 'ys_id', 'ys_type'],
			...
			listeners : {
				beforeload : function(store, operation, eOpts) {
					var form = Ext.getCmp('depositzyzjhistform').getForm();
					var values = form.getValues();
					var grid = Ext.getCmp('book_hist_deposit_zyzj_grid');
					if (form.isValid()) {
