Ext.define('Zixweb.view.book.hist.yfamt_ch_fhyd', {
	...
	initComponent : function() {
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('yfamtchfhydform')
									.getForm();
							var values = form.getValues();
							var grid = Ext.getCmp('book_hist_yfamt_ch_fhyd_grid');
							if (form.isValid()) {
		...
		this.items = [{
					...
					xtype : 'gridpanel',
					id : 'book_hist_yfamt_ch_fhyd_grid',
					height : 'auto',
