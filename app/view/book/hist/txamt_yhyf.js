Ext.define('Zixweb.view.book.hist.txamt_yhyf', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.book_hist_txamt_yhyf',
	...
	initComponent : function() {
		var store = new Ext.data.Store({
					fields : ['id', 'bfj_acct', 'zjbd_date', 'zjbd_type',
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							...
							var grid = Ext.getCmp('book_hist_txamt_yhyf_grid');
							if (form.isValid()) {
