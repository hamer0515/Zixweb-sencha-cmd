Ext.define('Zixweb.view.book.hist.bamt_yhyf', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.book_hist_bamt_yhyf',
		...
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							...
							var grid = Ext.getCmp('book_hist_bamt_yhyf_grid');
							if (form.isValid()) {
