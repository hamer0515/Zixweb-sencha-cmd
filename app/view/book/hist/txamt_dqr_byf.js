		...
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							...
							var grid = Ext
									.getCmp('book_hist_txamt_dqr_byf_grid');
							if (form.isValid()) {
		...
		this.items = [{
					...
					items : [{
								...
								items : [{
											...
											margin : '0 10 0 0',
											verify : {
												id : 'book_hist_txamt_dqr_byf_to_2'
											},
											vtype : 'dateinterval',
											width : 180
										}, {
					...
					xtype : 'gridpanel',
					id : 'book_hist_txamt_dqr_byf_grid',
					height : 'auto',
