Ext.define('Zixweb.view.book.hist.cost_bfee', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.book_hist_cost_bfee',
		...
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							...
							var grid = Ext.getCmp('book_hist_cost_bfee_grid');
							if (form.isValid()) {
