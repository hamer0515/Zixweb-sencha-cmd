Ext.define('Zixweb.view.book.hist.bsc_zyzj', {
	...
	initComponent : function() {
		var store = new Ext.data.Store({
			fields : ['id', 'zyzj_acct', 'e_date',  'period', 'j', 'd', 'ys_id', 'ys_type'],
			...
			listeners : {
				beforeload : function(store, operation, eOpts) {
					var form = Ext.getCmp('bsczyzjhistform').getForm();
					var values = form.getValues();
					var grid = Ext.getCmp('book_hist_bsc_zyzj_grid');
					if (form.isValid()) {
