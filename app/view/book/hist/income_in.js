Ext.define('Zixweb.view.book.hist.income_in', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.book_hist_income_in',
	...
	initComponent : function() {
		var store = new Ext.data.Store({
					fields : ['id', 'c', 'p', 'period', 'j', 'd', 'ys_id',
							'ys_type'],
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							...
							var grid = Ext.getCmp('book_hist_income_in_grid');
							if (form.isValid()) {
