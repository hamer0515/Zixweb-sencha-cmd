Ext.define('Zixweb.view.book.hist.yusamt_c_fhyd', {
	...
	initComponent : function() {
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('yusamtcfhydform')
									.getForm();
							var values = form.getValues();
							var grid = Ext.getCmp('book_hist_yusamt_c_fhyd_grid');
							if (form.isValid()) {
		...
		this.items = [{
					...
					xtype : 'gridpanel',
					id : 'book_hist_yusamt_c_fhyd_grid',
					height : 'auto',
