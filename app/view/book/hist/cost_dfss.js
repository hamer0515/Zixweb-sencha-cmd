Ext.define('Zixweb.view.book.hist.cost_dfss', {
		...
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							...
							var grid = Ext.getCmp('book_hist_cost_dfss_grid');
							if (form.isValid()) {
