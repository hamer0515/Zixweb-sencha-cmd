		...
		var store = new Ext.data.Store({
			...
			listeners : {
				beforeload : function(store, operation, eOpts) {
					var form = Ext.getCmp('wlzjysbfhistform').getForm();
					var values = form.getValues();
					var grid = Ext.getCmp('book_hist_wlzj_ysbf_grid');
					if (form.isValid()) {
