Ext.define('Zixweb.view.book.hist.blc_zyzj', {
	...
	initComponent : function() {
		var store = new Ext.data.Store({
					fields : ['id', 'zyzj_acct', 'period', 'e_date', 'j', 'd',
							'ys_id', 'ys_type'],
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('blczyzjhistform').getForm();
							var values = form.getValues();
							var grid = Ext.getCmp('book_hist_blc_zyzj_grid');
							if (form.isValid()) {
