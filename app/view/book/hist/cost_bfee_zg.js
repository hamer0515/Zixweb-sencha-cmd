Ext.define('Zixweb.view.book.hist.cost_bfee_zg', {
	...
	initComponent : function() {
		var store = new Ext.data.Store({
					fields : ['id', 'bi', 'c', 'p', 'fp', 'tx_date', 'period',
							'j', 'd', 'ys_id', 'ys_type'],
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							...
							var grid = Ext
									.getCmp('book_hist_cost_bfee_zg_grid');
							if (form.isValid()) {
		...
		this.items = [{
					...
					items : [{
								...
								items : [{
											...
											margin : '0 10 0 0',
											verify : {
												id : 'book_hist_cost_bfee_zg_to_2'
											},
											vtype : 'dateinterval',
											width : 180
										}, {
					...
					xtype : 'gridpanel',
					id : 'book_hist_cost_bfee_zg_grid',
					height : 'auto',
