Ext.define('Zixweb.view.book.hist.bfee_yhys', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.book_hist_bfee_yhys',
	...
	initComponent : function() {
		var store = new Ext.data.Store({
					fields : ['id', 'bfj_acct', 'period', 'zjbd_type',
							'zjbd_date', 'j', 'd', 'ys_id', 'ys_type'],
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('bfeeyhyshistform').getForm();
							var values = form.getValues();
							var grid = Ext.getCmp('book_hist_bfee_yhys_grid');
							if (form.isValid()) {
