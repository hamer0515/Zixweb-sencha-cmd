Ext.define('Zixweb.view.book.hist.txamt_dqr_oyf', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.book_hist_txamt_dqr_oyf',
	...
	initComponent : function() {
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							...
							var grid = Ext
									.getCmp('book_hist_txamt_dqr_oyf_grid');
							if (form.isValid()) {
		...
		this.items = [{
			...
			items : [{
						...
						items : [{
									...
									items : [{
												...
												margin : '0 10 0 0',
												verify : {
													id : 'book_hist_txamt_dqr_oyf_to_2'
												},
												vtype : 'dateinterval',
												width : 180
											}, {
			...
			title : '结果',
			xtype : 'gridpanel',
			id : 'book_hist_txamt_dqr_oyf_grid',
			height : 500,
