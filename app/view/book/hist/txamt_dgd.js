		...
		var store = new Ext.data.Store({
			...
			listeners : {
				beforeload : function(store, operation, eOpts) {
					var form = Ext.getCmp('txamtdgdhistform').getForm();
					var values = form.getValues();
					var grid = Ext.getCmp('book_hist_txamt_dgd_grid');
					if (form.isValid()) {
