Ext.define('Zixweb.view.fhydbook.detail.nctxamt_dqr_oys_fhyd', {
	...
	prefix : 'book_detail_nctxamt_dqr_oys_fhyd',
	defaults : {
		border : false
	},
	...
	initComponent : function() {
		...
		var grid = new Ext.grid.Panel({
					...
					columns : [columns.fhw_type, columns.fc, columns.ftx_date,
							columns.period, columns.f_ssn, columns.fs_rate,
							columns.j, columns.d]
				});
		this.items = [{
			xtype : 'form',
			...
			items : [{
						...
						handler : function() {
							...
							Ext.Ajax.request({
								async : false,
								url : 'book/detail/nctxamt_dqr_oys_fhyd_excel',
								params : params,
