Ext.define('Zixweb.view.fhydbook.detail.tctxamt_dqr_oys_fhyd', {
	...
	prefix : 'book_detail_tctxamt_dqr_oys_fhyd',
	defaults : {
		border : false
	},
	...
	initComponent : function() {
		...
		var store = new Ext.data.Store({
			fields : ['fhw_type', 'fc', 'ftx_date', 'period', 'fch_ssn',
					'f_rate', 'j', 'd'],
		...
		var grid = new Ext.grid.Panel({
					...
					columns : [columns.fhw_type, columns.fc, columns.ftx_date,
							columns.period, columns.fch_ssn, columns.f_rate,
							columns.j, columns.d]
				});
		this.items = [{
			xtype : 'form',
			...
			items : [{
						...
						handler : function() {
							...
							Ext.Ajax.request({
								async : false,
								url : 'book/detail/tctxamt_dqr_oys_fhyd_excel',
								params : params,
