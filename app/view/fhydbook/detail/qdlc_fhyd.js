Ext.define('Zixweb.view.fhydbook.detail.qdlc_fhyd', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.book_detail_qdlc_fhyd',
	...
	initComponent : function() {
		...
		store = Ext.create('widget.mystore', {
					_exportBtn : exportBtn = Ext.create('widget.exportbtn', {
								_url : 'book/detail/qdlc_fhyd_excel',
					...
					fields : ['fch', 'period', 'fe_date', 'fyw_type', 'j', 'd'],

					proxy : {
						type : 'ajax',
						api : {
							read : 'book/detail/qdlc_fhyd'
						},
						reader : {
							type : 'json',
							root : 'data',
