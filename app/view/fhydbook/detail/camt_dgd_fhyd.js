Ext.define('Zixweb.view.fhydbook.detail.camt_dgd_fhyd', {
	...
	prefix : 'book_detail_camt_dgd_fhyd',
	defaults : {
		border : false
	},
	...
	initComponent : function() {
		...
		var store = new Ext.data.Store({
					fields : ['fyw_type', 'fc', 'ftx_date', 'period',
							'fhw_type', 'f_ssn', 'fs_rate', 'j', 'd'],
		...
		var grid = new Ext.grid.Panel({
					...
					columns : [columns.fyw_type, columns.fc, columns.ftx_date,
							columns.period, columns.fhw_type, columns.f_ssn,
							columns.fs_rate, columns.j, columns.d]
				});
		this.items = [{
			xtype : 'form',
			title : '查询',
			...
			items : [{
						...
						handler : function() {
							...
							Ext.Ajax.request({
								async : false,
								url : 'book/detail/camt_dgd_fhyd_excel',
								params : params,
