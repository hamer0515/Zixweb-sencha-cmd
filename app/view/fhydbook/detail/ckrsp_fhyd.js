Ext.define('Zixweb.view.fhydbook.detail.ckrsp_fhyd', {
	...
	initComponent : function() {
		...
		var store = new Ext.data.Store({
					fields : ['f_ssn', 'fs_rate', 'fhw_type', 'fyw_type',
							'ftx_date', 'period', 'j', 'd'],
		...
		var grid = new Ext.grid.Panel({
					...
					columns : [columns.f_ssn, columns.fs_rate,
							columns.fhw_type, columns.fyw_type,
							columns.ftx_date, columns.period, columns.j,
							columns.d]
				});
		this.items = [{
			xtype : 'form',
			...
			items : [{
						...
						handler : function() {
							...
							Ext.Ajax.request({
								async : false,
								url : 'book/detail/ckrsp_fhyd_excel',
								params : params,
