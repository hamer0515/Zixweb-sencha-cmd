Ext.define('Zixweb.view.fhydbook.hist.qdsc_fhyd', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.book_hist_qdsc_fhyd',
	...
	initComponent : function() {
		...
		store = Ext.create('widget.mystore', {
			_exportBtn : exportBtn = Ext.create('widget.exportbtn', {
						_widget : 'tablefields',
						_bid : me.bid,
						_url : 'book/hist/qdsc_fhyd_excel',
						_grid : grid
					}),
			...
			fields : ['id', 'fyw_type', 'fch', 'fe_date', 'period', 'j', 'd',
					'ys_id', 'ys_type'],

			proxy : {
				type : 'ajax',
				api : {
					read : 'book/hist/qdsc_fhyd'
				},
				reader : {
					type : 'json',
					root : 'data',
		...
		grid = new Ext.grid.Panel({
					...
					columns : [Ext.columns.id, Ext.columns.fyw_type,
							Ext.columns.fch, Ext.columns.fe_date,
