	...
	initComponent : function() {
		...
		store = Ext.create('widget.mystore', {
			_exportBtn : exportBtn = Ext.create('widget.exportbtn', {
						_widget : 'tablefields',
						_bid : me.bid,
						_url : 'book/hist/yplc_fhyd_excel',
						_grid : grid
					}),
			...
			fields : ['id', 'fyw_type', 'fe_date', 'period', 'fyp_acct', 'j',
					'd', 'ys_id', 'ys_type'],
		...
		grid = new Ext.grid.Panel({
					...
					columns : [Ext.columns.id, Ext.columns.fyw_type,
							Ext.columns.fe_date, Ext.columns.period,
							Ext.columns.fyp_acct, Ext.columns.j, Ext.columns.d,
