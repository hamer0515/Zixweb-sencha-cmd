Ext.define('Zixweb.view.fhydbook.hist.income_add_fhyd', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.book_hist_income_add_fhyd',
	...
	initComponent : function() {
		var store = new Ext.data.Store({
					fields : ['id', 'fyw_type', 'fhw_type', 'period',
							'j', 'd', 'ys_id', 'ys_type'],
					...
					proxy : {
						type : 'ajax',
						api : {
							read : 'book/hist/income_add_fhyd'
						},
						reader : {
							type : 'json',
							root : 'data',
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('incomeaddfhyd').getForm();
							var values = form.getValues();
							var grid = Ext
									.getCmp('book_hist_income_add_fhyd_grid');
							if (form.isValid()) {
		...
		this.items = [{
					...
					items : [{
								...
								items : [{
											...
											allowBlank : false,
											verify : {
												id : 'book_hist_income_add_fhyd_to'
											},
											vtype : 'dateinterval',
											width : 180
										}, {
					...
					xtype : 'gridpanel',
					id : 'book_hist_income_add_fhyd_grid',
					height : 'auto',
