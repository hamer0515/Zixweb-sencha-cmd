	...
	initComponent : function() {
		...
		store = Ext.create('widget.mystore', {
			_exportBtn : exportBtn = Ext.create('widget.exportbtn', {
						_widget : 'tablefields',
						_bid : me.bid,
						_url : 'book/hist/ckrsp_fhyd_excel',
						_grid : grid
					}),
			...
			fields : ['id', 'fyw_type', 'ftx_date', 'period', 'fhw_type',
					'f_ssn', 'fs_rate', 'j', 'd', 'ys_id', 'ys_type'],
		...
		grid = new Ext.grid.Panel({
					...
					columns : [Ext.columns.id, Ext.columns.fyw_type,
							...
							Ext.columns.fch_rate, Ext.columns.j, Ext.columns.d,
