Ext.define('Zixweb.view.fhydbook.hist.ckrsp_fhyd', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.book_hist_ckrsp_fhyd',
	...
	initComponent : function() {
		var store = new Ext.data.Store({
					fields : ['id', 'fyw_type',  'ftx_date', 'period','fhw_type','f_ssn','fs_rate','j', 'd',
							'ys_id', 'ys_type'],
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('ckrspfhydform')
									.getForm();
							var values = form.getValues();
							var grid = Ext.getCmp('book_hist_ckrsp_fhyd_grid');
							if (form.isValid()) {
