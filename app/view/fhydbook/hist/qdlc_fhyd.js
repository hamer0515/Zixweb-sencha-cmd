Ext.define('Zixweb.view.fhydbook.hist.qdlc_fhyd', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.book_hist_qdlc_fhyd',
	...
	initComponent : function() {
		...
		store = Ext.create('widget.mystore', {
			_exportBtn : exportBtn = Ext.create('widget.exportbtn', {
						_widget : 'tablefields',
						_bid : me.bid,
						_url : 'book/hist/qdlc_fhyd_excel',
						_grid : grid
					}),
			...
			fields : ['id', 'fyw_type', 'fe_date', 'period', 'fch', 'j', 'd',
					'ys_id', 'ys_type'],

			proxy : {
				type : 'ajax',
				api : {
					read : 'book/hist/qdlc_fhyd'
				},
				reader : {
					type : 'json',
					root : 'data',
