		...
		var store = new Ext.data.Store({
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('incomemainfhydform').getForm();
							var values = form.getValues();
							var grid = Ext
									.getCmp('book_hist_income_main_fhyd_grid');
							if (form.isValid()) {
		...
		this.items = [{
					...
					items : [{
								...
								items : [{
											...
											allowBlank : false,
											verify : {
												id : 'book_hist_income_main_fhyd_to'
											},
											vtype : 'dateinterval',
											width : 180
										}, {
					...
					xtype : 'gridpanel',
					id : 'book_hist_income_main_fhyd_grid',
					height : 'auto',
