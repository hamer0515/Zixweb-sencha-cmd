Ext.define('Zixweb.view.fhydbook.hist.cost_fee_fhyd', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.book_hist_cost_fee_fhyd',
	...
	initComponent : function() {
		var store = new Ext.data.Store({
					fields : ['id', 'fyw_type', 'period','fhw_type','j', 'd',
							'ys_id', 'ys_type'],
					...
					listeners : {
						beforeload : function(store, operation, eOpts) {
							var form = Ext.getCmp('costfeefhydform')
									.getForm();
							var values = form.getValues();
							var grid = Ext.getCmp('book_hist_cost_fee_fhyd_grid');
							if (form.isValid()) {
		...
		this.items = [{
					...
					xtype : 'gridpanel',
					id : 'book_hist_cost_fee_fhyd_grid',
					height : 'auto',
